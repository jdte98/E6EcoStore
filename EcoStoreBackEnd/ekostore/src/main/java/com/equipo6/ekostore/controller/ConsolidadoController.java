package com.equipo6.ekostore.controller;
...
import com.equipo6.ekostore.repository.ConsolidadoRepository;
...
public class ConsolidadoController {
	...
	public ResponseEntity<Consolidado> createConsolidado(@RequestBody Consolidado consolidated){
		try{
			Consolidado _consolidado = consolidadoRepository.save(new Consolidado(consolidated.getCiudad(), consolidated.getTotalventas()));
